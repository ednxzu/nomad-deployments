job "qbittorrent" {
  ...
  group "qbittorrent" {
    ...
    task "wireguard" {
      ...
      config {
        image = "linuxserver/wireguard:latest@sha256:7dc8e7e90ef50f16637b5d51f174481676086c5f46461555fc270fa5f297976a"
        ports = ["qbt-tcp-udp"]
        cap_add = [
          "NET_ADMIN"
        ]
    ...
    task "qbittorrent" {
      driver = "docker"
      config {
        image        = "linuxserver/qbittorrent:latest@sha256:f83e2741b0b1b74901c97e36caa4aa3e0f2817c616426608eabf5aeef7f4a40a"
